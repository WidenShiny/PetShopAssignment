...
namespace SalesWinApp.Admin
{
    public partial class frmSalesStatistics : Form
    {
        ...
        private void LoadAllOrders()
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    CurrentGrid.UserId = int.Parse(dgvSales.Rows[0].Cells[1].Value.ToString());
                    ...
                    CurrentGrid.TotalMoney = decimal.Parse(dgvSales.Rows[0].Cells[5].Value.ToString());
                }
            }
            catch (Exception ex)
            {
        ...
        private void frmSalesStatistics_Load(object sender, EventArgs e)
        {
            ...
            CurrentGrid.UserId = int.Parse(dgvSales.Rows[CurrentRow].Cells[1].Value.ToString());
        ...
        private void dgvSales_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.RowIndex < _orderRepository.GetOrders().Count && e.RowIndex >= 0)
            {
                ...
                CurrentGrid.UserId = int.Parse(dgvSales.Rows[e.RowIndex].Cells[1].Value.ToString());
