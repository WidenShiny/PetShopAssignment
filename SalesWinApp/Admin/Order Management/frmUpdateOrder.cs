    ...
    public partial class frmUpdateOrder : Form
    {
        ...
        private void txtMemberID_TextChanged(object sender, EventArgs e)
        {
            if (txtMemberID.Text != "")
            {
                ...
                {
                    var tmpMember = _memberRepository.Getusers().FirstOrDefault(c => c.UserId == int.Parse(txtMemberID.Text));
                    if (tmpMember != null)
                    {
        ...
        private void frmUpdateOrder_Load(object sender, EventArgs e)
        {
            ...
            var Member = _memberRepository.Getusers().FirstOrDefault(c => c.UserId == Order.UserId);
            ...
            txtMemberID.Text = Order.UserId.ToString();
        ...
        private void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            {
                if (txtMemberID.Text != "" && txtProductID.Text != "" && txtOrderDate.Text != "" && txtTotalMoney.Text != "" && txtUnitPrice.Text != "" && txtQuantity.Text != "" && txtDiscount.Text != "")
                {
                    if (EmailOK)
                    {
                        if (ProductOK)
                        {
                            if (decimal.TryParse(txtTotalMoney.Text, out _) && decimal.Parse(txtTotalMoney.Text) >= 0)
                            {
                                if (decimal.TryParse(txtUnitPrice.Text, out _) && decimal.Parse(txtUnitPrice.Text) >= 0)
                                {
                                    ...
                                    {
                                            Order.UserId = int.Parse(txtMemberID.Text);
                                            ...
                                            Order.TotalMoney = decimal.Parse(txtTotalMoney.Text);
